...
- **Frontend**: React 19, Vite 8, Monaco Editor, Tailwind CSS
- **Lenguaje de Programación**: Intérprete educativo personalizado
...
Luego desactiva el entorno virtual:
...
→ Asegúrate de activar el entorno virtual (`.\.venv\Scripts\Activate.ps1`)

**"Port 8000 already in use"**
→ Otro proceso está usando ese puerto. Puedes cambiarlo en `app.py` o matar el proceso.
...
Proyecto educativo — siéntete libre de modificar y aprender.
